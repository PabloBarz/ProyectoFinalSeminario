...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      ...
      <?php 
      include '../ProyectoFinalSeminario/views/partials/_sidebar.php';
      ?>
      <!-- partial -->
      <div class="container-fluid page-body-wrapper">
        <!-- partial:partials/_navbar.html - NAVBAR TOP -->
        <?php 
      include '../ProyectoFinalSeminario/views/partials/_navbar.php';
      ?>
        ...
        <div class="main-panel">
          ...
          <!-- partial:partials/_footer.html - FOOTER-->
            ...
            require_once "../ProyectoFinalSeminario/views/partials/_footer.php";
            ?>
