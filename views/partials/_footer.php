<footer class="footer">
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © SporTV.com 2024</span>
    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-success"> Proyecto final de Seminario. </span>
  </div>
</footer>
...
<script src="<?= SERVERURL?>views/assets/vendors/chart.js/Chart.min.js"></script>
...
<script src="<?= SERVERURL?>views/assets/vendors/owl-carousel-2/owl.carousel.min.js"></script>
